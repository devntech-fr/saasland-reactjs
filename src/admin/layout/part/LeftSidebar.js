            ...
            <nav className="vertnav navbar navbar-light">
                <div className="w-100 mb-4 d-flex">
                    <a className="navbar-brand mx-auto mt-2 flex-fill text-center" href="./index.html">
                        <svg version="1.1" id="logo" className="navbar-brand-img brand-sm"
                    ...
                    <li className="nav-item dropdown">
                        ...
                        <ul className="collapse list-unstyled pl-4 w-100" id="dashboard">
                            <li className="nav-item active">
                                <a className="nav-link pl-3" href="./index.html"><span
                                    className="ml-1 item-text">Default</span></a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link pl-3" href="./dashboard-analytics.html"><span
                                    className="ml-1 item-text">Analytics</span></a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link pl-3" href="./dashboard-sales.html"><span
                                    className="ml-1 item-text">E-commerce</span></a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link pl-3" href="./dashboard-saas.html"><span
                                    className="ml-1 item-text">Saas Dashboard</span></a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link pl-3" href="./dashboard-system.html"><span
                                    className="ml-1 item-text">Systems</span></a>
                            </li>
                        </ul>
                    </li>
                </ul>
                ...
                <ul className="navbar-nav flex-fill w-100 mb-2">
                    <li className="nav-item dropdown">
                        ...
                        <ul className="collapse list-unstyled pl-4 w-100" id="ui-elements">
                            <li className="nav-item">
                                <a className="nav-link pl-3" href="./ui-color.html"><span
                                    className="ml-1 item-text">Colors</span>
                                </a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link pl-3" href="./ui-typograpy.html"><span
                                    className="ml-1 item-text">Typograpy</span></a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link pl-3" href="./ui-icons.html"><span
                                    className="ml-1 item-text">Icons</span></a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link pl-3" href="./ui-buttons.html"><span
                                    className="ml-1 item-text">Buttons</span></a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link pl-3" href="./ui-notification.html"><span
                                    className="ml-1 item-text">Notifications</span></a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link pl-3" href="./ui-modals.html"><span
                                    className="ml-1 item-text">Modals</span></a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link pl-3" href="./ui-tabs-accordion.html"><span
                                    className="ml-1 item-text">Tabs & Accordion</span></a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link pl-3" href="./ui-progress.html"><span
                                    className="ml-1 item-text">Progress</span></a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li className="nav-item dropdown">
                        ...
                        <ul className="collapse list-unstyled pl-4 w-100" id="forms">
                            <li className="nav-item">
                                <a className="nav-link pl-3" href="./form_elements.html"><span
                                    className="ml-1 item-text">Basic Elements</span></a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link pl-3" href="./form_advanced.html"><span
                                    className="ml-1 item-text">Advanced Elements</span></a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link pl-3" href="./form_validation.html"><span
                                    className="ml-1 item-text">Validation</span></a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link pl-3" href="./form_wizard.html"><span
                                    className="ml-1 item-text">Wizard</span></a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link pl-3" href="./form_layouts.html"><span
                                    className="ml-1 item-text">Layouts</span></a>
                            </li>
                            <li className="nav-item">
                    ...
                    <li className="nav-item dropdown">
                        ...
                        <ul className="collapse list-unstyled pl-4 w-100" id="tables">
                            ...
                            <li className="nav-item">
                                <a className="nav-link pl-3" href="./table_advanced.html"><span
                                    className="ml-1 item-text">Advanced Tables</span></a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link pl-3" href="./table_datatables.html"><span
                                    className="ml-1 item-text">Data Tables</span></a>
                            </li>
                        </ul>
                    </li>
                    <li className="nav-item dropdown">
                        ...
                        <ul className="collapse list-unstyled pl-4 w-100" id="charts">
                            <li className="nav-item">
                                <a className="nav-link pl-3" href="./chart-inline.html"><span
                                    className="ml-1 item-text">Inline Chart</span></a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link pl-3" href="./chart-chartjs.html"><span
                                    className="ml-1 item-text">Chartjs</span></a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link pl-3" href="./chart-apexcharts.html"><span
                                    className="ml-1 item-text">ApexCharts</span></a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link pl-3" href="./datamaps.html"><span
                                    className="ml-1 item-text">Datamaps</span></a>
                            </li>
                        </ul>
                    </li>
                </ul>
                ...
                <ul className="navbar-nav flex-fill w-100 mb-2">
                    ...
                    <li className="nav-item dropdown">
                        ...
                        <ul className="collapse list-unstyled pl-4 w-100" id="contact">
                            <a className="nav-link pl-3" href="./contacts-list.html"><span
                                className="ml-1">Contact List</span></a>
                            <a className="nav-link pl-3" href="./contacts-grid.html"><span
                                className="ml-1">Contact Grid</span></a>
                            <a className="nav-link pl-3" href="./contacts-new.html"><span
                                className="ml-1">New Contact</span></a>
                        </ul>
                    </li>
                    <li className="nav-item dropdown">
                        ...
                        <ul className="collapse list-unstyled pl-4 w-100" id="profile">
                            <a className="nav-link pl-3" href="./profile.html"><span
                                className="ml-1">Overview</span></a>
                            <a className="nav-link pl-3" href="./profile-settings.html"><span
                                className="ml-1">Settings</span></a>
                            <a className="nav-link pl-3" href="./profile-security.html"><span
                                className="ml-1">Security</span></a>
                            <a className="nav-link pl-3" href="./profile-notification.html"><span
                                className="ml-1">Notifications</span></a>
                        </ul>
                    </li>
                    <li className="nav-item dropdown">
                        ...
                        <ul className="collapse list-unstyled pl-4 w-100" id="fileman">
                            <a className="nav-link pl-3" href="./files-list.html"><span
                                className="ml-1">Files List</span></a>
                            <a className="nav-link pl-3" href="./files-grid.html"><span
                                className="ml-1">Files Grid</span></a>
                        </ul>
                    </li>
                    <li className="nav-item dropdown">
                        ...
                        <ul className="collapse list-unstyled pl-4 w-100" id="support">
                            ...
                            <a className="nav-link pl-3" href="./support-tickets.html"><span
                                className="ml-1">Tickets</span></a>
                            <a className="nav-link pl-3" href="./support-ticket-detail.html"><span className="ml-1">Ticket Detail</span></a>
                            <a className="nav-link pl-3" href="./support-faqs.html"><span
                                className="ml-1">FAQs</span></a>
                        </ul>
                    </li>
                </ul>
                <p className="text-muted nav-heading mt-4 mb-1">
                ...
                <ul className="navbar-nav flex-fill w-100 mb-2">
                    ...
                    <li className="nav-item dropdown">
                        ...
                        <ul className="collapse list-unstyled pl-4 w-100" id="auth">
                            ...
                            <a className="nav-link pl-3" href="./auth-login-half.html"><span
                                className="ml-1">Login 2</span></a>
                            <a className="nav-link pl-3" href="./auth-register.html"><span
                                className="ml-1">Register</span></a>
                    ...
                    <li className="nav-item dropdown">
                        ...
                        <ul className="collapse list-unstyled pl-4 w-100" id="layouts">
                            ...
                            <li className="nav-item">
                                <a className="nav-link pl-3" href="./index-horizontal.html"><span
                                    className="ml-1 item-text">Top Navigation</span></a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link pl-3" href="./index-boxed.html"><span
                                    className="ml-1 item-text">Boxed</span></a>
                            </li>
                        </ul>
                    </li>
                </ul>
                ...
                <div className="btn-box w-100 mt-4 mb-1">
                    <button type="button" className="btn mb-2 btn-primary btn-lg btn-block">
                        <i className="fe fe-shopping-cart fe-12 mr-2"></i><span className="small">Buy now</span>
                    </button>
                </div>
            </nav>
        </aside>
