...
class CloudBanner extends RichContent {
    state = {
        open: false
    };
                    ...
                    <div className="row">
                        <div className="col-lg-6 d-flex align-items-center">
                            <div className="software_banner_content">
                                <h2 className="f_500 f_size_50 w_color wow fadeInLeft" data-wow-delay="0.2s" dangerouslySetInnerHTML={this.displayTitle()}></h2>
                                <p className="w_color f_size_18 l_height30 mt_30 wow fadeInLeft" data-wow-delay="0.4s" dangerouslySetInnerHTML={this.displayParagraph()}></p>
                                <div className="action_btn d-flex align-items-center mt_40 wow fadeInLeft" data-wow-delay="0.6s">
                                    {buttonLink && <a href={buttonLink.href} target={buttonLink.target} className="software_banner_btn">{buttonLink.label}</a>}
