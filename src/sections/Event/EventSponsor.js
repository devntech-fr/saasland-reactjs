...
import EventSponsorLogo from "sections/Event/EventSponsorLogo";
import { displayTitle } from "components/Content/RichContent";

const EventSponsor = ({ title, sponsors, buttonLinks }) => {
  return (
        ...
        <div className="event_sponser_inner">
          <div className="event_sponser_item">
            <div className="row">
              ...
              <div className="col-lg-9 col-md-8">
                <div className="row">
                  <EventSponsorLogo url=".#" image="logo_01.png" />
                  <EventSponsorLogo url=".#" image="logo_02.png" />
                </div>
              </div>
            </div>
          </div>
          <div className="event_sponser_item">
            <div className="row">
              ...
              <div className="col-lg-9 col-md-8">
                <div className="row">
                  <EventSponsorLogo url=".#" image="logo_05.png" />
                  <EventSponsorLogo url=".#" image="logo_06.png" />
                  <EventSponsorLogo url=".#" image="logo_07.png" />
                </div>
              </div>
            </div>
          </div>
          <div className="event_sponser_item">
            <div className="row">
              ...
              <div className="col-lg-9 col-md-8">
                <div className="row">
                  <EventSponsorLogo url=".#" image="logo_09.png" />
                  <EventSponsorLogo url=".#" image="logo_10.png" />
                  <EventSponsorLogo url=".#" image="logo_11.png" />
                  <EventSponsorLogo url=".#" image="logo_12.png" />
                  <EventSponsorLogo url=".#" image="logo_05.png" />
                  <EventSponsorLogo url=".#" image="logo_06.png" />
                  <EventSponsorLogo url=".#" image="logo_07.png" />
                </div>
