    ...
    render(){
        ...
        return(
            <footer className="footer_area footer_area h_footer_dark pos_footer_area security_footer_area">
                <img className="leaf_left" src={"/img/pos/leaf-left.png"} alt=""/>
                <img className="leaf_right" src={"/img/pos/leaf-right.png"} alt=""/>
                <div className="container">
                                    ...
                                    <Reveal effect="fadeInLeft" duration={500} key={1}>
                                        <div className="col-lg-4 col-sm-6" >
                                            <div className="f_widget dark_widget company_widget" data-wow-delay="0.2s">
                                                <a href="index.html" className="f-logo"><img src={"/img/logo2.png"} alt=""/></a>
                    ...
                    <div className="pos_footer_bottom justify-content-between d-flex align-items-end">
                        <img className="pos_women" src={"/img/pos/women.png"} alt=""/>
                        <img src={"/img/pos/people.png"} alt=""/>
                        <img className="pos_women" src={"/img/pos/man.png"} alt=""/>
                    </div>
                </div>
